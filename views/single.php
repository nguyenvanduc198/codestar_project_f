...
session_start(); ?>
<?php
include_once '.././components/client/header.php';
?>
                        ...
                        <div class="select-product">
                            ...
                            <div class="bx-wrapper" style="max-width: 264px;">
                                <div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 80px;">
                                    <ul class="nav nav-tabs select-product-tab bxslider" style="width: 815%; position: relative; transition-duration: 0s; transform: translate3d(-249.984px, 0px, 0px);">
                                        <li style="float: left; list-style: none; position: relative; width: 83.3333px;" class="bx-clone">
                                        ...
                                        <li class="active" style="float: left; list-style: none; position: relative; width: 83.3333px;">
                                            <a href="#thumbnail_1" data-toggle="tab"><img src="img/product/sidebar_product/1.jpg" alt="pro-thumbnail"></a>
                                        </li>
                                        <li style="float: left; list-style: none; position: relative; width: 83.3333px;">
                                        ...
                                        <li class="active bx-clone" style="float: left; list-style: none; position: relative; width: 83.3333px;">
                                            <a href="#thumbnail_1" data-toggle="tab"><img src="img/product/sidebar_product/1.jpg" alt="pro-thumbnail"></a>
                                        </li>
                                        <li style="float: left; list-style: none; position: relative; width: 83.3333px;" class="bx-clone">
                                            <a href="#thumbnail_2" data-toggle="tab"><img src="img/product/sidebar_product/2.jpg" alt="pro-thumbnail"></a>
                                ...
                                <div class="bx-controls bx-has-pager bx-has-controls-direction">
                                    ...
                                    <div class="bx-controls-direction"><a class="bx-prev" href=""><i class="fa fa-angle-right"></i></a><a class="bx-next" href=""><i class="fa fa-angle-left"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class=" row">
                                ...
                                <div class="related-product owl-carousel owl-theme" style="opacity: 1; display: block;">
                                    ...
                                    <div class="owl-wrapper-outer">
                                        <div class="owl-wrapper" style="width: 4732px; left: 0px; display: block; transition: all; transform: translate3d(0px, 0px, 0px);">
                                    ...
                                    <div class="owl-controls clickable">
                                        <div class="owl-buttons">
                                            <div class="owl-prev"><i class="fa fa-angle-left owl-prev-icon"></i></div>
                                            <div class="owl-next"><i class="fa fa-angle-right owl-next-icon"></i></div>
                                        </div>
                                    </div>
                                </div>
...
<?php
include_once '.././components/client/footer.php';
?>